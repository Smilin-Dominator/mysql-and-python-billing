...
so if you check about 1 minute afterwards, it creates a new file, as the name contains the Hour and Minute!</font>
...
- View ([shows the bill])
    ...
    - It'll show you all the items in the cart and the total.
- Invoice (Cash Given: )
    - To enter this screen , press (enter) without any other input in the ID Prompt.
    - Enter the amount of cash given, if the balance is negative, it keeps asking you for the correct amount, until you give the correct amount.
